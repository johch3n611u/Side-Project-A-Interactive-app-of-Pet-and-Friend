...
## 架構
  ...
  1. [CSS框架 使用Bootstrap3&4 利用MVC_Layout區分3與4](#)
  1. [利用HTML5 Input type實現基本驗證](#)
  1. [考量SEO 使用HTML5 語意標籤](#)
  1. [jQ實現DOM操作](#)
  1. [利用Ajax 實現異步更新](#)
  1. [API串接後端驗證圖形](#)
...
1. [foreach](#) 
1. [while](#) 
1. [Webform_StandardControls](#) 
1. [Webform_MemberForm](#) 
1. [Webform_Validation](#) 
1. [DB_Connection](#) 
1. [GridView_DataSource](#) 
1. [GridView_Paging](#) 
1. [GridView_Search](#) 
1. [GridView_BoundField](#) 
1. [GridView_BottonField](#) 
1. [GridView_HyperLinkField](#) 
1. [CommandField](#) 
1. [DataList_itemTeamlate](#) 
1. [DataList_SelectedItemTemplate](#) 
1. [DataList_Edit](#) 
1. [SQL_StoredProcedure](#) 
1. [QR_Code](#) 
1. [ADOnet_SqlDataAdapter](#) 
1. [ADOnet_SqlDataReader](#) 
1. [Product_Search_QR_Code](#) 
1. [Member_Registeration](#) 
1. [Smtp_Client](#) 
1. [Auth_OK](#) 
1. [FormView](#) 
1. [GetMemberPhoto](#) 
