...
namespace PetPet
{
    ...
    /// GetAuthImg 的摘要描述
    /// </summary>
    public class GetAuthImg : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            context.Session["VerfiNumber"] = strNumber;
            ...
            Random r = new Random();
            int intRed = r.Next(255, 256);
            int intGreen = r.Next(255, 256);
            int intBlue = r.Next(255, 256);
